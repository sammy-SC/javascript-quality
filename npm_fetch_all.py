...
save_destination = 'data/npm-all.pickled'
...
def _process_data(data):
    '''
    '''
    # name, users, contributors, maintainers, repository.url, license
    ...
    for k, v in data.items():
        ...
        if ('url' in v.get('repository', [])
            and 'github.com' in v.get('repository').get('url')):
